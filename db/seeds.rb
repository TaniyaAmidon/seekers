...
arthur1.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552313312/Screen_Shot_2019-03-11_at_14.08.11.png")
# arthur1.remote_photo_url = cl_image_tag("lnaag3ngxq575iwdpidi.jpg")
arthur1.save!
...
kitty2.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552301652/fshasg9kcrijswyixakj.png")
kitty2.save!
...
sophie3.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552314039/sophie_s_-_profile.jpg")
sophie3.save!
...
ife4.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552312069/Screen_Shot_2019-03-11_at_13.47.25.png")
ife4.save!
...
tanyia5.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552314115/Screen_Shot_2019-03-11_at_14.21.22.png")
tanyia5.save!
...
dan6.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552314290/dan_v.jpg")
dan6.save!
...
trip1 = Trip.new(group: group1, user_id: arthur1.id, title: "Exhilerating week Skiing in the Alps", destination: "France", start_date: Date.new(2019, 8, 15),
  ...
  trip1.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552299568/nvedstpzhx0hnj6qenx6.jpg")
  trip1.save!
...
trip2 = Trip.create!(group: group2, user_id: kitty2.id, title: "Water rafting in Norway", destination: "Norway", start_date: Date.new(2019, 6, 14),
  ...
  trip2.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552324784/photo-1530866495561-507c9faab2ed.jpg")
  trip2.save!
...
trip3 = Trip.create!(group: group3, user_id: sophie3.id, title: "Sky Diving in New Zealand", destination: "New Zealand", start_date: Date.new(2019, 7, 1),
  ...
  trip3.photo = open("https://res.cloudinary.com/sophiespratley/image/upload/v1552324963/photo-1529573603507-70ad30917905.jpg")
  trip3.save!

puts "manual trips created!"
